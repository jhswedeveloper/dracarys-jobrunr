...
public class JobRunrConfig {
    ...
    public JobRunrConfig() {
        this.jsonMapper = new JobRunrGsonMapper();
     ...
     */
    public JobRunrConfig useStorageProvider(StorageProvider storageProvider) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig withJobFilter(JobFilter... jobFilters) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServer() {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServerIf(boolean guard) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServer(int workerCount) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServerIf(boolean guard, int workerCount) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServer(BackgroundJobServerConfiguration configuration) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDefaultBackgroundJobServerIf(boolean guard, BackgroundJobServerConfiguration configuration) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useBackgroundJobServer(BackgroundJobServer backgroundJobServer) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useBackgroundJobServerIf(boolean guard, BackgroundJobServer backgroundJobServer) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboard() {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboardIf(boolean guard) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboard(int dashboardPort) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboardIf(boolean guard, int dashboardPort) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboard(JobRunrDashboardWebServerConfiguration configuration) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useDashboardIf(boolean guard, JobRunrDashboardWebServerConfiguration configuration) {
        if (guard) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useJobActivator(JobActivator jobActivator) {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useJmxExtensions() {
     ...
     * @return the same configuration instance which provides a fluent api
     */
    public JobRunrConfig useJmxExtensionsIf(boolean guard) {
        if (guard) {
